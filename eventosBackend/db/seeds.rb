...
User.create(name:"Sergio", lastname: "Castro", nickname: "scastro", email: "sergio@mail.com")
User.create(name:"Jose", lastname: "Molano", nickname: "jmolano", email: "jose@mail.com")
